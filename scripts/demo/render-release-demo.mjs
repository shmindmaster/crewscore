...
// A poster is a visual preview rather than an accessibility surface. Extract
// it from the clean master so the product state remains legible at a glance;
// the captioned master and standalone caption files stay in the package.
run("ffmpeg", ["-y", "-ss", "00:00:32", "-i", cleanMaster, "-frames:v", "1", "-update", "1", poster]);

...
*Validation snapshot: package `0.6.1`, ruleset `crewscore-hygiene@0.5.0`, corpus report generated by `py scripts/validate_corpus.py`. The reproducible 356-prompt report supersedes the withdrawn 1,368-prompt study.*
